...
class ProductTeaserDataTest extends \Magento\TestFramework\TestCase\AbstractBackendController
{
    ...
    public function testItReturnCorrectProductData()
    {
        ...
        $this->dispatch('/backend/content-constructor/component/productteaserdata?sku=' . $product->getSku());
        ...
        $this->assertContains('adminhtml/Magento/backend/en_US/Magento_Catalog/images/product/placeholder/small_image.jpg', $productData['product']['image']);
