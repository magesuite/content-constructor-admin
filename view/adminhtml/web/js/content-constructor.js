(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.contentConstructor = factory(global.jquery, global.Vue, global.VueResource, null, global["mage/translate"], global["Magento_Ui/js/modal/modal"], global["Magento_Ui/js/modal/alert"], global.uiRegistry, global["Magento_Ui/js/modal/confirm"]));
    ...
    var vr__default = /*#__PURE__*/_interopDefaultLegacy(vr);
    var $t__default = /*#__PURE__*/_interopDefaultLegacy($t);
    var modal__default = /*#__PURE__*/_interopDefaultLegacy(modal);
    var alert__default = /*#__PURE__*/_interopDefaultLegacy(alert);
    var uiRegistry__default = /*#__PURE__*/_interopDefaultLegacy(uiRegistry);
    var confirm__default = /*#__PURE__*/_interopDefaultLegacy(confirm);
    ...
    ***************************************************************************** */
    ...
    var componentPicker = {
        ...
        methods: {
            ...
            translate: function (txt) {
                return $__default["default"].mage.__(txt);
            },
            /**
    ...
    var teaserPreview = {
        ...
        methods: {
            ...
            formatAspectRatio: function (aspectRatio) {
                if (aspectRatio.length) {
                    var rawArr = aspectRatio.split(':');
                    return "".concat((rawArr[1] / rawArr[0]) * 100, "%");
                }
                return '0';
            },
        },
    ...
    var heroCarouselPreview = {
        ...
        methods: {
            ...
            setImagesLoadListener: function () {
                var _this = this;
                var $images = $__default["default"](this.$els.scene).find('img');
                    ...
                    $images.on('load', function () {
                        ...
                        if (!imagesCount) {
                            ...
                            $images.each(function () {
                                $__default["default"](this).addClass('cc-hero-carousel-preview__item-image--border');
                            });
                        }
                    })
                        .filter(function () {
            ...
            hideEmptySlideContents: function () {
                $__default["default"](this.$els.scene).find('.cc-hero-carousel-preview__slide-content-info').each(function () {
                    if (!$__default["default"](this).children().length) {
    ...
    var imageTeaserPreview = {
        ...
        methods: {
                ...
                if (imagesCount) {
                    $images.on('load', function () {
                        ...
                        if (!imagesCount) {
                            _this.isLoading = false;
                            $images.each(function () {
                                $__default["default"](this).addClass('cc-image-teaser-preview__item-image--border');
                            });
                        }
                    })
                        .filter(function () {
            ...
            hideEmptySlideContents: function () {
                $__default["default"](this.$els.scene)
                ...
                if (imagesCount) {
                    $images.on('load', function () {
                        ...
                        if (!imagesCount) {
                            _this.isLoading = false;
                            $images.each(function () {
                                $__default["default"](this).addClass('cc-image-teaser-legacy-preview__item-image--border');
                            });
                        }
                    })
                        .filter(function () {
    ...
    var productGridPreview = {
        ...
        computed: {
            itemsGridClass: function () {
                if (this.teaserExists) {
                    return "cc-products-grid-preview__list cc-products-grid-preview__list--".concat(this.configuration.items[0].position);
                }
                if (this.heroExists) {
                    return "cc-products-grid-preview__list cc-products-grid-preview__list--".concat(this.configuration.hero.position);
                }
        ...
        methods: {
            ...
            hideEmptySlideContents: function () {
                $__default["default"](this.$els.scene).find('.cc-products-grid-preview__hero-content').each(function () {
                    if (!$__default["default"](this).children().length) {
                        $__default["default"](this).hide();
                    }
                });
    ...
    var customComponentsConfigurator = {};
    var customComponentsPreview = {};
    ...
    var layoutBuilder = {
         ...
         * Get dependencies
         */
        components: __assign({ 'action-button': actionButton, 'component-adder': componentAdder, 'component-actions': componentActions, 'component-display-controller': componentDisplayController, 'component-placeholder': componentPlaceholder, 'brand-carousel-preview': brandCarouselPreview, 'button-preview': buttonPreview, 'category-links-preview': categoryLinksPreview, 'cms-teaser-preview': cmsPagesTeaserPreview, 'custom-html-preview': customHtmlPreview, 'daily-deal-teaser-preview': dailyDealTeaserPreview, 'headline-preview': headlinePreview, 'hero-carousel-preview': heroCarouselPreview, 'image-teaser-preview': imageTeaserLegacyPreview, 'image-teaser-2-preview': imageTeaserPreview, 'magento-product-grid-teasers-preview': magentoProductGridTeasersPreview, 'paragraph-preview': paragraphPreview, 'product-carousel-preview': productCarouselPreview, 'product-finder-preview': productFinderPreview, 'product-grid-preview': productGridPreview, 'separator-preview': separatorPreview, 'static-cms-block-preview': staticBlockPreview, 'icon-preview': iconPreview, 'teaser-and-text-preview': teaserAndTextPreview, 'instagram-feed-preview': instagramFeedPreview, 'mosaic-preview': mosaicPreview, 'accordion-preview': accordionPreview, 'product-teaser-preview': productTeaserPreview }, customComponentsPreview),
        props: {
            /**
             * Class property support to enable BEM mixes.
             */
        ...
        ready: function () {
            ...
            var storedCopiedComponents = localStorage.getItem('magesuite-cc-admin-copied-components');
            this.copiedComponents = storedCopiedComponents ? JSON.parse(storedCopiedComponents).map(function (el) { return el.id; }) : [];
        ...
        methods: {
             ...
             */
            pasteComponent: function (index) {
                var componentsData = localStorage.getItem('magesuite-cc-admin-copied-components');
                if (!componentsData) {
                    alert__default["default"]({
                        title: $t__default["default"]('In order to paste a component first copy another component.'),
                    });
                    return;
                }
                var components = JSON.parse(componentsData);
                var builder = this;
                var buttons = [];
                    ...
                    buttons.push({
                        ...
                        click: function () {
                            ...
                            builder.$nextTick(function () {
                                setTimeout(builder.animateAddingComponent(builder.components[index].id, component.id), 200);
                            });
                        }
                    });
                });
                if (components.length > 1) {
                    buttons.push({
                        text: $t__default["default"]('Paste all copied components'),
                ...
                buttons.push({
                    text: $t__default["default"]('Clear copied components list'),
                ...
                alert__default["default"]({
                    title: $t__default["default"]('Choose component to paste'),
             ...
             */
            animateAddingComponent: function (originId, duplicateId) {
                var $origin = $__default["default"]("#".concat(originId));
                var $duplicate = $__default["default"]("#".concat(duplicateId));
                ...
                setTimeout(function () {
                    ...
                    var scrollDown = $origin.offset().top < $duplicate.offset().top;
            ...
            moveComponentUp: function (index) {
                ...
                if (index > 0) {
                    ...
                    var $thisComponent_1 = $__default["default"]("#".concat(this.components[index].id));
                    var $prevComponent_1 = $__default["default"]("#".concat(this.components[index - 1].id));
                    $thisComponent_1
                        .addClass('cc-layout-builder__component--animating')
                        .css('transform', "translateY(".concat(-Math.abs($prevComponent_1.outerHeight(true)), "px)"));
                    $prevComponent_1
                        .addClass('cc-layout-builder__component--animating')
                        .css('transform', "translateY(".concat($thisComponent_1.outerHeight(true), "px)"));
                    setTimeout(function () {
            ...
            moveComponentDown: function (index) {
                ...
                if (index < this.components.length - 1) {
                    ...
                    var $thisComponent_2 = $__default["default"]("#".concat(this.components[index].id));
                    var $nextComponent_1 = $__default["default"]("#".concat(this.components[index + 1].id));
                    $thisComponent_2
                        .addClass('cc-layout-builder__component--animating')
                        .css('transform', "translateY(".concat($nextComponent_1.outerHeight(true), "px)"));
                    $nextComponent_1
                        .addClass('cc-layout-builder__component--animating')
                        .css('transform', "translateY(".concat(-Math.abs($thisComponent_2.outerHeight(true)), "px)"));
                    setTimeout(function () {
                        _this.components.$set(index + 1, _this.components[index]);
            ...
            generateNewComponentId: function (oldId) {
                ...
                return "".concat(newId, "_duplicate").concat(Math.floor(Math.random() * (99999 - 2 + 1) + 2));
            },
            /**
            ...
            duplicateComponent: function (index) {
                ...
                this.$nextTick(function () {
                    _this.animateAddingComponent(_this.components[index].id, duplicate.id);
                });
            },
            /**
             ...
             * @param {number} index Original component's index in array.
             */
            copyComponent: function (index) {
                if (this.isAlreadyCopied(this.components[index].id)) {
                    alert__default["default"]({
                        title: $t__default["default"]('The component has been already copied before'),
                    });
                }
                else {
                    var oldCopiedComponents = localStorage.getItem('magesuite-cc-admin-copied-components') || '[]';
                    var newCopiedComponents = __spreadArray(__spreadArray([], JSON.parse(oldCopiedComponents), true), [this.components[index]], false).slice(-10);
                    localStorage.setItem('magesuite-cc-admin-copied-components', JSON.stringify(newCopiedComponents));
                    this.copiedComponents.push(this.components[index].id);
                    this.copiedComponents = this.copiedComponents.slice(-10);
                    alert__default["default"]({
                        title: $t__default["default"]('The component was copied'),
                        content: $__default["default"].mage.__('You can copy up to 10 components and paste them later into Content Constructor area on other CMS/PDP/POP page.'),
                    });
                }
            },
            /**
            ...
            setupInitialDisplayProps: function () {
                for (var i = 0; i < this.components.length; i++) {
                    ...
                    if (!c.data.hasOwnProperty('componentVisibility') &&
                        ...
                        var componentInfo = $__default["default"].extend(true, {}, c, {
                            data: {
                                componentVisibility: {
                                    mobile: true,
                                    desktop: true,
             ...
             * @return {boolean}
             */
            isPossibleToCopy: function (component) {
                return !this.getIsSpecialComponent(component.type);
            },
            /**
             ...
             * @return {boolean}
             */
            isAlreadyCopied: function (id) {
                return this.copiedComponents.some(function (el) { return el === id; });
            },
            /**
            ...
            deleteComponent: function (index) {
                var builder = this;
                confirm__default["default"]({
                    content: $t__default["default"]('Are you sure you want to delete this item?'),
                    actions: {
                        confirm: function () {
            ...
            deleteStaticBlock: function (cmsBlockId) {
                var component = this;
                confirm__default["default"]({
                    content: $t__default["default"]('Would you like to delete CMS Block related to this component (CMS Block ID: %s) ?').replace('%s', cmsBlockId),
                    actions: {
                        confirm: function () {
    ...
    var customFieldTextInput = {
        ...
        filters: {
            ...
            prefixFieldId: function (id) {
                return "cfg-teaser-".concat(this.teaserIndex, "-").concat(id);
            },
        },
        ready: function () {
            /**
    ...
    var customFieldCheckbox = {
        ...
        ready: function () {
            ...
            if (this.configuration[this.fieldConfiguration.model] == null &&
                ...
                this.$set("configuration.".concat(this.fieldConfiguration.model), this.fieldConfiguration.checked);
            }
        },
    };

    var customFieldRadio = {
    ...
    var customFieldPosition = {
        ...
        computed: {
            ...
            gridWidth: function () {
                return "".concat(this.columns * 4, "rem");
            },
        },
        methods: {
        ...
        ready: function () {
             ...
             */
            if (this.configuration[this.fieldConfiguration.model] == null) {
                this.$set("configuration.".concat(this.fieldConfiguration.model), {});
        ...
        methods: {
            validateAndUpdateValue: function () {
                if (this.validateDates()) {
                    var fromTimestamp = this.datetime_from.length ? "".concat(Math.floor(new Date(this.datetime_from).getTime() / 1000)) : '';
                    var toTimestamp = this.datetime_to.length ? "".concat(Math.floor(new Date(this.datetime_to).getTime() / 1000)) : '';
                    this.$set("configuration.".concat(this.fieldConfiguration.model), "".concat(fromTimestamp, "|").concat(toTimestamp));
                }
            },
        ...
        ready: function () {
            ...
            require(['moment'], function (moment) {
                if (self.configuration[self.fieldConfiguration.model]) {
                    var dateRange = self.configuration[self.fieldConfiguration.model].split('|');
                     ...
                     * Set default value if model is not set yet and default value is defined in etc/view.xml
                     */
                    self.$set("configuration.".concat(self.fieldConfiguration.model), self.fieldConfiguration.default);
                }
            });
        },
    };

    var customFieldColor = {
        ...
        methods: {
            updateValue: function (e) {
                this.$set("configuration.".concat(this.fieldConfiguration.model), e.target.value);
            }
        },
        ready: function () {
            /**
    ...
    var componentConfigurator = {
        components: {
            ...
            'custom-element-datetime-range': customFieldDatetimeRange,
    ...
    var buttonConfigurator = {
        ...
        methods: {
            ...
            openCtaTargetModal: function () {
                widgetTools.openDialog("".concat(window.location.origin, "/").concat(this.adminPrefix, "/admin/widget/index/filter_widgets/Link/widget_target_id/cfg-target/"));
            ...
            widgetSetListener: function () {
                var component = this;
                $__default["default"]('.cc-button-configurator__cta-target-link').on('change', function () {
                    component.onChange();
                });
            },
            /*
    ...
    var templates = {
        getComponentTemplate: function (classes, placeholders, disabledClass) {
            return "<div class=\"cc-input__fake-select | ".concat(classes.input.base, " ").concat(disabledClass, "\">").concat(placeholders.select, "</div>\n        <div class=\"").concat(classes.input.base, "-opener\"></div>\n        <div class=\"").concat(classes.menu.base, "\">\n            <div class=\"").concat(classes.search.wrapper, "\">\n                <input class=\"cc-input__input | ").concat(classes.search.input, "\" data-role=\"advanced-select-text\" type=\"text\" placeholder=\"").concat(placeholders.search, "\">\n                <div class=\"").concat(classes.search.resultsQty, "\"></div>\n            </div>\n            <div class=\"").concat(classes.menu.content, "\"></div>\n            <div class=\"").concat(classes.search.resultsWrapper, "\"></div>\n            <div class=\"").concat(classes.actions.wrapper, "\">\n                <button class=\"action-default | ").concat(classes.actions.button, "\" type=\"button\">").concat(placeholders.doneButton, "</button>\n            </div>\n        </div>");
        },
        ...
        getCrumbTemplate: function (baseClass, crumbLabel, title, inputValue) {
            return "<span class=\"".concat(baseClass, "__crumb\">\n            <span class=\"").concat(baseClass, "__crumb-text\">").concat(crumbLabel, "</span>\n            <button class=\"").concat(baseClass, "__crumb-remove\" type=\"button\" title=\"").concat(title, "\" tabindex=\"-1\" data-value=\"").concat(inputValue, "\"></button>\n        </span>");
        },
    };

    var categoryPicker = /** @class */ (function () {
        /**
        ...
        function categoryPicker($output, data, options) {
            this._defaults = {
                ...
                placeholders: {
                    select: $t__default["default"]('Select...'),
                    doneButton: $t__default["default"]('Done'),
                    search: $t__default["default"]('Type category name to search...'),
                    empty: $t__default["default"]('There are no categories matching your selection'),
                    removeCrumb: $t__default["default"]('Remove this category'),
                },
                classes: {
            ...
            this._options = $__default["default"].extend(true, {}, this._defaults, options);
        ...
        categoryPicker.prototype.updatePicker = function (inputs) {
            ...
            var ids = $__default["default"](inputs).map(function () {
                return this.value;
            }).get().join(',');
            this._categoriesLabels = $__default["default"](inputs).map(function () {
                return $__default["default"](this).next('label').clone().children().remove().end().text();
            });
            var crumbs = $__default["default"](inputs).map(function () {
                var label = $__default["default"](this).next('label').clone().children().remove().end().text();
            ...
            if (crumbs !== '') {
                this._$wrapper.find(".".concat(c.input.base)).html(crumbs);
            }
            else {
                this._$wrapper.find(".".concat(c.input.base)).html(this._options.placeholders.select);
            }
        ...
        categoryPicker.prototype.openSubcategoriesTree = function ($item) {
            var c = this._options.classes;
            $item.find("> .".concat(c.dropdown.ul)).toggleClass("".concat(c.dropdown.ul, "--hidden"));
            $item.find("> .".concat(c.dropdown.li, "-content .").concat(c.dropdown.toggler)).toggleClass("".concat(c.dropdown.toggler, "--active"));
        };
        /**
         * Opens picker's box
        ...
        categoryPicker.prototype.openPicker = function ($wrapper) {
            ...
            this.closePicker($__default["default"](".".concat(this._options.classes.base)));
            $wrapper.find('.cc-input__fake-select').addClass('cc-input__fake-select--active');
            $wrapper.find(".".concat(this._options.classes.menu.base)).addClass("".concat(this._options.classes.menu.base, "--open"));
            this._isOpen = true;
        };
        /**
         * Closes picker's box
        ...
        categoryPicker.prototype.closePicker = function ($wrapper) {
            ...
            $wrapper.find(".".concat(this._options.classes.menu.base)).removeClass("".concat(this._options.classes.menu.base, "--open"));
            this._isOpen = false;
        };
        /**
        ...
        categoryPicker.prototype.showChildrenOnly = function (id) {
            ...
            if (target.optgroup) {
                this._orderedCheckboxes = [];
                this._$wrapper.find(".".concat(this._options.classes.menu.content)).html(this._getContents(target.optgroup, '', "".concat(this._options.classes.dropdown.ul, "--normal")));
                this._afterBuild(false);
                this._rebuildValues();
                this._setEvents();
            }
            else {
                this._$wrapper.find(".".concat(this._options.classes.menu.content)).html(this._options.placeholders.empty);
            }
        };
        /**
         * Enables picker
        ...
        categoryPicker.prototype.enable = function () {
            this._$wrapper.find(".".concat(this._options.classes.input.base)).removeClass("".concat(this._options.classes.input.base, "--disabled"));
        ...
        categoryPicker.prototype.disable = function () {
            this._$wrapper.find(".".concat(this._options.classes.input.base)).addClass("".concat(this._options.classes.input.base, "--disabled"));
        ...
        categoryPicker.prototype.resetAll = function () {
            ...
            this._$wrapper.find(".".concat(this._options.classes.input.base)).html(this._options.placeholders.select);
            this._orderedCheckboxes = [];
            this._categoriesLabels = [];
        };
        /**
        ...
        categoryPicker.prototype._renderPicker = function () {
            var c = this._options.classes;
            var t = this._options.placeholders;
            var disabledClass = this._options.disabled ? "".concat(c.input.base, "--disabled") : '';
            var tpl = '';
            ...
            this._$output.wrap("<div class=\"".concat(c.base, " ").concat(c.baseMix, "\"></div>"));
            this._$wrapper = this._$output.parent(".".concat(c.base));
            this._$wrapper.append(tpl);
            if (this._categoriesData.optgroup) {
                this._$wrapper.find(".".concat(c.menu.content)).html(this._getContents(this._categoriesData.optgroup, ''));
            }
            else {
                this._$wrapper.find(".".concat(c.menu.content)).html(t.empty);
            }
        };
        /**
        ...
        categoryPicker.prototype._renderSearchResults = function (data) {
            ...
            var _this = this;
            var result = '';
            this._$wrapper.find(".".concat(c.search.resultsWrapper)).html('');
            if (data.length) {
                result += "<ul class=\"".concat(c.search.resultsUL, "\">");
                for (var i = 0; i < data.length; i++) {
                    var path = $__default["default"](data[i].path).map(function () {
                        return this;
                    }).get().join(' / ');
                    var checked = $__default["default"]("#cp-".concat(this._prefix, "-").concat(data[i].value)).prop('checked') ? 'checked' : '';
                    var disabled = $__default["default"]("#cp-".concat(this._prefix, "-").concat(data[i].value)).prop('disabled') ? 'disabled' : '';
                    result += "<li class=\"".concat(c.search.resultsLI, "\" role=\"option-group\">");
                    if (this._options.multiple) {
                        result += "<div class=\"cc-input cc-input--type-checkbox\">\n                        <input class=\"cc-input__checkbox | ".concat(c.dropdown.checkbox, "\" type=\"checkbox\" value=\"").concat(data[i].value, "\" name=\"cp-sr-").concat(this._prefix, "[]\" id=\"cp-sr-").concat(this._prefix, "-").concat(data[i].value, "\" tabindex=\"-1\" ").concat(checked, " ").concat(disabled, ">");
                    }
                    else {
                        result += "<div class=\"cc-input cc-input--type-radio\">\n                        <input class=\"cc-input__radio | ".concat(c.dropdown.radio, "\" type=\"radio\" value=\"").concat(data[i].value, "\" name=\"cp-sr-").concat(this._prefix, "[]\" id=\"cp-sr-").concat(this._prefix, "-").concat(data[i].value, "\" tabindex=\"-1\" ").concat(checked, " ").concat(disabled, ">");
                    }
                    result += "<label for=\"cp-sr-".concat(this._prefix, "-").concat(data[i].value, "\" class=\"cc-input__label | ").concat(c.search.label, "\">\n                    ").concat(data[i].label, "\n                    <span class=\"").concat(c.search.resultsPath, "\">").concat(path, "</span>\n                </label></div>\n                </li>");
                }
                result += '</ul>';
            }
            this._$wrapper.find(".".concat(c.search.resultsWrapper)).html(result);
            this._$wrapper.find(".".concat(c.search.resultsUL, " input[type=\"checkbox\"]")).off('change').on('change', function () {
                _this._$wrapper.find(".".concat(c.menu.content, " :input[value=\"").concat(this.value, "\"]")).trigger('click');
            });
            var text = data.length === 1 ? "".concat(data.length, " ").concat($t__default["default"]('Result')) : "".concat(data.length, " ").concat($t__default["default"]('Results'));
            this._$wrapper.find(".".concat(this._options.classes.search.resultsQty)).html(text);
            this._setEvents();
        };
        /**
        ...
        categoryPicker.prototype._getByQuery = function (category, query, path) {
            ...
            if (category.optgroup) {
                ...
                category.optgroup.forEach(function (subcategory) {
                    _this_1._getByQuery(subcategory, query, categoryPath_1).map(function (cat) {
        ...
        categoryPicker.prototype._getContents = function (categories, str, dropdownModifier) {
            ...
            str += "<ul class=\"".concat(c.dropdown.ul, " ").concat(c.dropdown.ul, "--hidden ").concat(dropdownModifier, "\">");
            /**
            ...
            for (var i = 0; i < categories.length; i++) {
                if (categories[i].is_active === '1') {
                    var checked = $__default["default"]("#cp-".concat(this._prefix, "-").concat(categories[i].value)).prop('checked') ? 'checked' : '';
                    str += "<li class=\"".concat(c.dropdown.li, "\" data-role=\"option-group\">");
                    if (this._options.multiple) {
                        str += "<div class=\"cc-input cc-input--type-checkbox | ".concat(c.dropdown.li, "-content\">\n                        <input class=\"cc-input__checkbox | ").concat(c.dropdown.checkbox, "\" type=\"checkbox\" value=\"").concat(categories[i].value, "\" name=\"cp-").concat(this._prefix, "[]\" id=\"cp-").concat(this._prefix, "-").concat(categories[i].value, "\" tabindex=\"-1\" ").concat(checked, ">");
                    }
                    else {
                        str += "<div class=\"cc-input cc-input--type-radio | ".concat(c.dropdown.li, "-content\">\n                        <input class=\"cc-input__radio | ").concat(c.dropdown.radio, "\" type=\"radio\" value=\"").concat(categories[i].value, "\" name=\"cp-").concat(this._prefix, "[]\" id=\"cp-").concat(this._prefix, "-").concat(categories[i].value, "\" tabindex=\"-1\" ").concat(checked, ">");
                    }
                    str += "<label for=\"cp-".concat(this._prefix, "-").concat(categories[i].value, "\" class=\"cc-input__label | ").concat(c.dropdown.label, "\">").concat(categories[i].label, "</label>");
                    if (categories[i].optgroup && categories[i].optgroup.length && this._options.showChildren) {
                        str += "<div class=\"".concat(c.dropdown.toggler, "\"></div></div>\n                        ").concat(this._getContents(categories[i].optgroup, ''));
                    }
                    else {
                        str += '</div>';
                    }
        ...
        categoryPicker.prototype._afterBuild = function (openSubTree) {
            ...
            var c = this._options.classes;
            var _this = this;
            this._$wrapper.find(".".concat(c.menu.content, " > .").concat(c.dropdown.ul)).removeClass("".concat(c.dropdown.ul, "--hidden"));
            if (openSubTree) {
                this.openSubcategoriesTree(this._$wrapper.find(".".concat(c.menu.content, " > ul > li:first-child")));
            }
            this._$wrapper.find(".".concat(c.dropdown.li)).each(function () {
                if ($__default["default"](this).find(".".concat(c.dropdown.ul)).length) {
                    $__default["default"](this).addClass("".concat(c.dropdown.li, "--has-children"));
                }
                else if (_this._options.disableLastLevelItems) {
                    $__default["default"](this).addClass("".concat(c.dropdown.li, "--disabled")).find('input').prop('disabled', true);
                }
            });
        };
        /**
        ...
        categoryPicker.prototype._rebuildValues = function () {
            if (this._$output[0].value !== '') {
                ...
                for (var i = 0; i < values.length; i++) {
                    var $cb = this._$wrapper.find(".".concat(this._options.classes.menu.content, " input[value=\"").concat(values[i], "\"]"));
                    if ($cb.length) {
        ...
        categoryPicker.prototype._setEvents = function () {
            ...
            this._$wrapper.find(".".concat(c.input.base, "-opener")).off('click').on('click', function () {
                if (_this._isOpen) {
                    _this.closePicker($__default["default"](this).parents(".".concat(c.base)));
                }
                else {
                    _this.openPicker($__default["default"](this).parents(".".concat(c.base)));
                }
            });
            this._$wrapper.find(".".concat(c.actions.button)).off('click').on('click', function () {
                _this.closePicker($__default["default"](this).parents(".".concat(c.base)));
            });
            this._$wrapper.find(".".concat(c.dropdown.toggler)).off('click').on('click', function () {
                _this.openSubcategoriesTree($__default["default"](this).parents(".".concat(c.dropdown.li)).first());
            });
            this._$wrapper.find(".".concat(c.menu.content, " input[type=\"checkbox\"]")).off('change').on('change', function () {
                ...
                for (var i = void 0; i < _this._orderedCheckboxes.length; i++) {
                    ...
                    if (_this._$wrapper.find(".".concat(c.search.resultsUL, " input[value=\"").concat(val, "\"]")).length) {
                        _this._$wrapper.find(".".concat(c.menu.content, " input[value=\"").concat(val, "\"]")).prop('checked', true);
                    }
                }
                _this.updatePicker(_this._orderedCheckboxes);
            });
            this._$wrapper.find(".".concat(c.menu.base, " input[type=\"radio\"]")).off('change').on('change', function () {
                if (_this._$wrapper.find(".".concat(c.search.resultsUL, " input[value=\"").concat(this.value, "\"]")).length) {
                    _this._$wrapper.find(".".concat(c.menu.content, " input[value=\"").concat(this.value, "\"]")).prop('checked', true);
                }
                _this.updatePicker(this);
            });
            this._$wrapper.find(".".concat(c.search.input)).off('keyup').on({
                keyup: function (e) {
                    if (this.value.length >= _this._options.minSearchQueryLength) {
                        ...
                        _this._$wrapper.find(".".concat(c.search.resultsWrapper)).show();
                        _this._$wrapper.find(".".concat(c.search.resultsQty)).show();
                        _this._$wrapper.find(".".concat(c.menu.content)).hide();
                    }
                    else {
                        _this._$wrapper.find(".".concat(c.search.resultsWrapper)).hide();
                        _this._$wrapper.find(".".concat(c.search.resultsQty)).hide();
                        _this._$wrapper.find(".".concat(c.menu.content)).show();
                    }
                },
            });
        };
        ...
        categoryPicker.prototype._setCrumbsEvents = function () {
            var _this = this;
            this._$wrapper.find(".".concat(_this._options.classes.base, "__crumb-remove")).off('click').on('click', function (e) {
                var $target = _this._$wrapper.find(".".concat(_this._options.classes.menu.content, " input[value=\"").concat($__default["default"](this).data('value'), "\"]"));
                var $srTarget = _this._$wrapper.find(".".concat(_this._options.classes.search.resultsWrapper, " input[value=\"").concat($__default["default"](this).data('value'), "\"]"));
    ...
    var cmsPagesTeaserConfigurator = {
        ...
        ready: function () {
            if (this.cmsTags !== '') {
                this.categoryPicker = new categoryPicker($__default["default"]('#cp-cms-pages-teaser'), JSON.parse(this.cmsTags), {
                    multiple: true,
                    minSearchQueryLength: 1,
                    placeholders: {
                        select: $t__default["default"]('Select tags...'),
                        doneButton: $t__default["default"]('Done'),
                        search: $t__default["default"]('Type tag-name to search...'),
                        empty: $t__default["default"]('There are no tags matching your selection'),
                        removeCrumb: $t__default["default"]('Remove this tag'),
                    },
                    classes: {
    ...
    var dailyDealTeaserConfigurator = {
        ...
        ready: function () {
            ...
            this.$http.get(this.categoriesDataUrl).then(function (response) {
                _this.categoryPicker = new categoryPicker($__default["default"]('#cp-daily-deal-teaser'), JSON.parse(response.body), {
                    multiple: false,
                });
                // Hide loader
                $__default["default"]('body').trigger('hideLoadingPopup');
    ...
    var MATCH_URL_FILE = /(^\{\{media url=")|($\}\})/;
    var getVideoTypeFromUrl = function (url) {
        switch (true) {
    ...
    var teaserConfigurator = {
        ...
        methods: {
            ...
            getMediaUploader: function (index, type) {
                var url;
                if (type === 'video') {
                    url = "".concat(this.uploaderBaseUrl, "target_element_id/teaser-video-").concat(index, "/");
                }
                else {
                    url = this.currentImageUploader === 'desktop' ?
                        "".concat(this.uploaderBaseUrl, "target_element_id/teaser-img-").concat(index, "/") :
                        "".concat(this.uploaderBaseUrl, "target_element_id/teaser-img-").concat(this.currentImageUploader, "-").concat(index, "/");
                }
                MediabrowserUtility.openDialog(url, 'auto', 'auto', $__default["default"].mage.__('Insert File...'), {
                    closed: true,
                });
            },
            onVideoFileUrlChange: function (event, teaserIndex) {
            ...
            onRawImageUrlChange: function (event) {
                ...
                if (this.currentImageUploader !== 'desktop') {
                    this.$set("configuration.image.".concat(this.currentImageUploader, ".raw"), rawValue);
                    this.$set("configuration.image.".concat(this.currentImageUploader, ".decoded"), decoded);
                }
                else {
                ...
                var img = new Image();
                img.onload = function () {
                    var aspectRatio = _this_1.getAspectRatio(img.naturalWidth, img.naturalHeight);
                    var imgPath = img.getAttribute('src');
                    if (_this_1.currentImageUploader !== 'desktop') {
                        if (_this_1.configuration.image[_this_1.currentImageUploader] && _this_1.configuration.image[_this_1.currentImageUploader].image) {
                            _this_1.$set("configuration.image.".concat(_this_1.currentImageUploader, ".image"), imgPath);
                        }
                        else {
                            _this_1.$set("configuration.image.".concat(_this_1.currentImageUploader, ".raw"), imgPath);
                        }
                        _this_1.$set("configuration.image.".concat(_this_1.currentImageUploader, ".aspect_ratio"), aspectRatio);
                    }
                    else {
                        if (_this_1.configuration.image && _this_1.configuration.image.image) {
                            _this_1.$set('configuration.image.image', imgPath);
                        }
                        else {
                            _this_1.$set('configuration.image.raw', imgPath);
                        }
                        _this_1.$set('configuration.image.aspect_ratio', aspectRatio);
                    }
                    /**
                     ...
                     */
                    if (_this_1.supportBreakpointDedicatedImages) {
                        ['mobile', 'tablet', 'desktop'].forEach(function (item) {
                            if (item === 'desktop') {
                                if (_this_1.configuration.image.aspect_ratio === '') {
                                    _this_1.$set('configuration.image.image', imgPath);
                                    _this_1.$set('configuration.image.raw', imgPath);
                                    _this_1.$set('configuration.image.aspect_ratio', aspectRatio);
                                    _this_1.$set('configuration.image.decoded', decoded);
                                }
                            }
                            else {
                                if (_this_1.configuration.image[item].aspect_ratio === '') {
                                    _this_1.$set("configuration.image.".concat(item, ".image"), imgPath);
                                    _this_1.$set("configuration.image.".concat(item, ".raw"), imgPath);
                                    _this_1.$set("configuration.image.".concat(item, ".aspect_ratio"), aspectRatio);
                                    _this_1.$set("configuration.image.".concat(item, ".decoded"), decoded);
                                }
                            }
                        });
                    }
                    setTimeout(function () {
                        _this_1.checkImageSizes();
                        _this_1.onChange();
                    }, 400);
                };
            ...
            moveImageTeaserUp: function (index) {
                var _this_1 = this;
                if (index > 0) {
                    var $thisItem_1 = $__default["default"]("#cc-image-teaser-item-".concat(index));
                    var $prevItem_1 = $__default["default"]("#cc-image-teaser-item-".concat(index - 1));
                    $thisItem_1
                        .addClass('cc-teaser-configurator--animating')
                        .css('transform', "translateY(".concat(-Math.abs($prevItem_1.outerHeight(true)), "px)"));
                    $prevItem_1
                        .addClass('cc-teaser-configurator--animating')
                        .css('transform', "translateY(".concat($thisItem_1.outerHeight(true), "px )"));
                    setTimeout(function () {
                        _this_1.parentConfigurationVariation.splice(index - 1, 0, _this_1.parentConfigurationVariation.splice(index, 1)[0]);
                        $thisItem_1
            ...
            moveImageTeaserDown: function (index) {
                ...
                if (index < this.parentConfigurationVariation.length - 1) {
                    var $thisItem_2 = $__default["default"]("#cc-image-teaser-item-".concat(index));
                    var $nextItem_1 = $__default["default"]("#cc-image-teaser-item-".concat(index + 1));
                    $thisItem_2
                        .addClass('cc-teaser-configurator--animating')
                        .css('transform', "translateY(".concat($nextItem_1.outerHeight(true), "px)"));
                    $nextItem_1
                        .addClass('cc-teaser-configurator--animating')
                        .css('transform', "translateY(".concat(-Math.abs($thisItem_2.outerHeight(true)), "px)"));
                    setTimeout(function () {
                        _this_1.parentConfigurationVariation.splice(index + 1, 0, _this_1.parentConfigurationVariation.splice(index, 1)[0]);
                        $thisItem_2
                            .removeClass('cc-teaser-configurator--animating')
            ...
            toggleTeaserAndTextItems: function (index) {
                var _this_1 = this;
                var $thisItem = $__default["default"]("#cc-image-teaser-item-0");
                var $nextItem = $__default["default"]("#cc-image-teaser-item-1");
                $__default["default"](".cc-teaser-configurator").toggleClass('cc-teaser-configurator--text-only');
                $thisItem
                    .addClass('cc-teaser-configurator--animating')
                    .css('transform', "translateX(".concat($nextItem.outerWidth(true), "px)"));
                $nextItem
                    .addClass('cc-teaser-configurator--animating')
                    .css('transform', "translateX(".concat(-Math.abs($thisItem.outerWidth(true)), "px)"));
                setTimeout(function () {
                    $thisItem
                        .removeClass('cc-teaser-configurator--animating')
                        .css('transform', '');
                    $nextItem
                        .removeClass('cc-teaser-configurator--animating')
                        .css('transform', '');
                    _this_1.parentConfiguration.items.reverse();
                    _this_1.onChange();
                }, 400);
            },
            /**
            ...
            openCtaTargetModal: function (index) {
                widgetTools.openDialog("".concat(window.location.origin, "/").concat(this.adminPrefix, "/admin/widget/index/filter_widgets/Link/widget_target_id/cfg-teaser-").concat(index, "-cta-href/"));
            ...
            wWidgetListener: function (itemIndex) {
                ...
                if (typeof wWidget !== 'undefined' &&
                    ...
                    button.onclick = null;
                    button.addEventListener('click', function () {
                        _this_1.configuration.cta.href = '';
                        wWidget.insertWidget();
                    });
                }
                else {
                    window.setTimeout(function () {
                        _this_1.wWidgetListener(itemIndex);
                    }, 300);
                }
            },
            ...
            deleteTeaserItem: function (index) {
                ...
                if (this.callerComponentType === 'mosaic') {
                    ...
                    confirm__default["default"]({
                        content: $__default["default"].mage.__('Are you sure you want to delete this item?'),
                        actions: {
                            confirm: function () {
            ...
            checkImageSizes: function () {
                ...
                if ($__default["default"]('.modal-popup.confirm._show').length || this.callerComponentType === 'mosaic') {
                    return;
                }
                ...
                for (var i = 0; i < itemsToCheck.length; i++) {
                    if (itemsToCheck[i].image.aspect_ratio !==
                        ...
                        alert__default["default"]({
                            title: $__default["default"].mage.__('Warning'),
                            content: $__default["default"].mage.__('Images you have uploaded have different aspect ratio. This may cause this component to display wrong. We recommend to keep the same aspect ratio for all uploaded images.'),
                        });
                        return false;
                    }
                }
            ...
            getAspectRatio: function (a, b) {
                ...
                return "".concat(a / c, ":").concat(b / c);
            },
            handleJqEvents: function () {
                var _this_1 = this;
                $__default["default"](".cc-teaser-configurator__image-url[data-teaser-index=\"".concat(this.teaserIndex, "\"]"))
                    .off('change')
                    .on('change', this.onRawImageUrlChange);
                $__default["default"](".cc-teaser-configurator__video-url[data-teaser-index=\"".concat(this.teaserIndex, "\"]"))
                    .off('change')
                    .on('change', function (event) { _this_1.onVideoFileUrlChange(event, _this_1.teaserIndex); });
            },
             ...
             * @param teaserIndex
             */
            toggleVideoConfig: function (teaserIndex) {
                this.videoInputVisible = !this.videoInputVisible;
                if (this.videoInputVisible) {
                    document.getElementById("cfg-teaser-".concat(teaserIndex, "-video-link")).focus();
                }
            },
            /**
             ...
             */
            setVideoData: function (teaserIndex) {
                if (this.videoInputValue.length) {
                    var videoType = getVideoTypeFromUrl(this.videoInputValue);
                    if (videoType) {
                        ...
                        alert__default["default"]({
                            title: $__default["default"].mage.__('Warning'),
                            content: "\n                            ".concat($__default["default"].mage.__('Please make sure that provided URL is correct'), " \n\n                        "),
                        });
                    }
                }
             ...
             * @param teaserIndex
             */
            initSloganWysiwyg: function (teaserIndex) {
                var _this = this;
                var sloganEditor;
                require([
                    'mage/adminhtml/wysiwyg/tiny_mce/setup',
                ], function () {
                    Event.observe("toggle-slogan-wysiwyg-".concat(teaserIndex), 'click', function () {
                        if (!sloganEditor) {
                            sloganEditor = new wysiwygSetup("cfg-teaser-".concat(teaserIndex, "-slogan"), _this.wysiwygConfig);
            ...
            initDescriptionWysiwyg: function (teaserIndex) {
                var _this = this;
                var descriptionEditor;
                require([
                    'mage/adminhtml/wysiwyg/tiny_mce/setup',
                ], function () {
                    Event.observe("toggle-description-wysiwyg-".concat(teaserIndex), 'click', function () {
                        if (!descriptionEditor) {
                            descriptionEditor = new wysiwygSetup("cfg-teaser-".concat(teaserIndex, "-description"), _this.wysiwygConfig);
        ...
        ready: function () {
            ...
            if (this.callerComponentType === 'products-grid') {
                if (!this.configuration.image.aspect_ratio) {
                    ...
                    tempImg_1.onload = function () {
                        _this_1.configuration.image.aspect_ratio = _this_1.getAspectRatio(tempImg_1.width, tempImg_1.height);
                    };
                }
            }
            ...
            $__default["default"]("#cc-image-teaser-item-".concat(this.teaserIndex, " .cc-teaser-configurator")).toggleClass('cc-teaser-configurator--text-only', this.configuration.teaserType === 'text-only');
    ...
    var heroCarouselConfigurator = {
        ...
        data: function () {
            return {
                ...
                imageUploadedText: $t__default["default"]('Change'),
                noImageUploadedText: $t__default["default"]('Upload'),
                scenarioOptions: {
                    // Mobile layout scenario elements.
                    mobileDisplayVariant: {
                        list: {
            ...
            mapLegacyConfiguration: function () {
                ...
                if (isLegacyTeaserConfiguration) {
                    this.configuration.items.forEach(function (item, index) {
                        ...
                        _this.$set("configuration.items[".concat(index, "]"), newItem);
                    });
        ...
        ready: function () {
            if (!this.configuration.mobileDisplayVariant.id) {
                $__default["default"]('.cc-hero-carousel-configurator__option:first-child').click();
            }
        },
        created: function () {
    ...
    var imageTeaserConfigurator$1 = {
                ...
                write: function (newStepContent, oldStepContent, stepIndex) {
                    ...
                    try {
                        ...
                        if (err.hasOwnProperty('message')) {
                            alert__default["default"]("Error in teaser ".concat(stepIndex, ": ").concat(err.message));
                        }
                    }
                    if (result) {
                        return result;
        ...
        methods: {
            ...
            toggleOption: function (optionCategory, optionId) {
                ...
                this.$delete("configuration.scenario.".concat(optionCategory), 'error');
            ...
            updateConfigurationProp: function () {
                ...
                this.configuration = $__default["default"].extend({}, propDefaults, this.configuration, true);
            },
            _validateOptionsSet: function () {
                for (var _i = 0, _a = Object.keys(this.configuration.scenario); _i < _a.length; _i++) {
                    ...
                    if (scenario !== 'numberOfSlides') {
                        this.$delete("configuration.scenario.".concat(scenario), 'error');
                        if (!this.configuration.scenario[scenario].id || this.configuration.scenario[scenario].id === '') {
                            this.$set("configuration.scenario.".concat(scenario, ".error"), 'Please choose one of available options');
            ...
            _validateVideoPlaceholders: function () {
                ...
                var _a;
                this.invalidVideoPlaceholderTeaserIndexes = [];
                if ((_a = this.configuration.items) === null || _a === void 0 ? void 0 : _a.length) {
                    this.configuration.items.forEach(function (teaser, index) {
                        if (teaser.video &&
                            teaser.video.url.length &&
                            !teaser.image.raw) {
    ...
    var iconConfigurator = {
        extends: imageTeaserConfigurator$1,
        props: {
            /* Caller component type */
            callerComponentType: {
                type: String,
    ...
    var teaserItemPrototype = {
        ...
        subheadline: '',
        paragraph: '',
        ctaLabel: $t__default["default"]('More'),
        href: '',
        sizeInfo: '',
        aspectRatio: '',
    };
    ...
    var imageTeaserConfigurator = {
        ...
        methods: {
            ...
            getImageUploader: function (index) {
                MediabrowserUtility.openDialog("".concat(this.uploaderBaseUrl, "target_element_id/image-teaser-img-").concat(index, "/"), 'auto', 'auto', $t__default["default"]('Insert File...'), {
                    closed: true,
                });
            },
            ...
            imageUploadListener: function () {
                ...
                $__default["default"](document).on('change', '.cc-image-teaser-legacy-configurator__image-url', function (event) {
                    if (!isAlreadyCalled) {
            ...
            onImageUploaded: function (input) {
                ...
                img.onload = function () {
                    ...
                    _this.configuration.items[itemIndex].sizeInfo = "".concat(img.naturalWidth, "x").concat(img.naturalHeight, "px (").concat(ar, ")");
            ...
            moveImageTeaserUp: function (index) {
                var _this = this;
                if (index > 0) {
                    var $thisItem_1 = $__default["default"]("#cc-image-teaser-legacy-item-".concat(index));
                    var $prevItem_1 = $__default["default"]("#cc-image-teaser-legacy-item-".concat(index - 1));
                    $thisItem_1
            ...
            moveImageTeaserDown: function (index) {
                ...
                if (index < this.configuration.items.length - 1) {
                    var $thisItem_2 = $__default["default"]("#cc-image-teaser-legacy-item-".concat(index));
                    var $nextItem_1 = $__default["default"]("#cc-image-teaser-legacy-item-".concat(index + 1));
                    $thisItem_2
                        .addClass('cc-image-teaser-legacy-configurator__item--animating')
                        .css('transform', "translateY(".concat($nextItem_1.outerHeight(true), "px)"));
                    $nextItem_1
             ...
             */
            openCtaTargetModal: function (index) {
                widgetTools.openDialog("".concat(window.location.origin, "/").concat(this.adminPrefix, "/admin/widget/index/filter_widgets/Link/widget_target_id/image-teaser-ctatarget-output-").concat(index, "/"));
                this.wWidgetListener(index);
            },
            /* Sets listener for widget chooser
             * It triggers component.onChange to update component's configuration
            ...
            widgetSetListener: function () {
                var _this = this;
                $__default["default"]('.cc-image-teaser-legacy-configurator__cta-target-link').on('change', function () {
                    _this.onChange();
                });
            },
            /*
            ...
            checkImageSizes: function () {
                ...
                for (var i = 0; i < itemsToCheck.length; i++) {
                    if (itemsToCheck[i].aspectRatio !== itemsToCheck[0].aspectRatio) {
                        alert__default["default"]({
                            title: $t__default["default"]('Warning'),
                            content: $t__default["default"]('Images you have uploaded have different aspect ratio. This may cause this component to display wrong. We recommend to keep the same aspect ratio for all uploaded images.'),
                        });
                        return false;
                    }
                }
    ...
    var paragraphConfigurator = {
        ...
        ready: function () {
            ...
            if (this.configuration.blockId && !this.configuration.migrated) {
                ...
                this.$http({
                    ...
                    method: 'get',
                    url: "".concat(window.location.origin, "/rest/all/V1/cmsBlock/").concat(this.configuration.blockId),
                }).then(function (response) {
                    ...
                    // Hide loader
                    $__default["default"]('body').trigger('hideLoadingPopup');
                    _this_1.$set('configuration.content', responseData.content);
                    _this_1.$set('configuration.title', responseData.title);
                    // initialize customized WYSIWYG
                    if (_this_1.wysiwygCfg) {
                        _this_1.initWysiwyg();
                    }
                }, function () {
                    $__default["default"]('body').trigger('hideLoadingPopup');
        ...
        methods: {
            ...
            openWidgetModal: function () {
                widgetTools.openDialog("".concat(this.wysiwygCfg.plugins[1].options.window_url, "widget_target_id/textarea-cfg-paragraph/"));
            },
            /* Opens modal with M2 built-in media uploader
             */
            openMediaModal: function () {
                MediabrowserUtility.openDialog("".concat(this.uploaderBaseUrl, "target_element_id/textarea-cfg-paragraph/"), 'auto', 'auto', $t__default["default"]('Insert File...'), {
                    closed: true,
                });
            },
    ...
    var productCarouselConfigurator = {
        ...
        ready: function () {
            ...
            // Get categories JSON with AJAX
            this.$http.get(this.categoriesDataUrl).then(function (response) {
                _this.categoryPicker = new categoryPicker($__default["default"]('#cp-products-carousel'), JSON.parse(response.body), {
                    multiple: false,
                });
                // Hide loader
                $__default["default"]('body').trigger('hideLoadingPopup');
    ...
    var ccProductFinderConfigurator = {
        ...
        methods: {
            ...
            deleteStep: function (stepIndex) {
                var component = this;
                confirm__default["default"]({
                    content: $__default["default"].mage.__('Are you sure you want to delete this step?'),
                    actions: {
                        confirm: function () {
            ...
            getImageUploader: function (stepIndex) {
                MediabrowserUtility.openDialog("".concat(this.uploaderBaseUrl, "target_element_id/pf-imgholder-").concat(stepIndex), 'auto', 'auto', $__default["default"].mage.__('Insert File...'), {
                    closed: true,
                });
            },
            /* Listener for image uploader
            ...
            imageUploadListener: function () {
                ...
                var isAlreadyCalled = false;
                // jQuery has to be used, for some reason native addEventListener doesn't catch change of input's value
                $__default["default"](document).on('change', '.cc-product-finder-configurator__imgholder', function (event) {
                    if (!isAlreadyCalled) {
                        isAlreadyCalled = true;
            ...
            setImageUrl: function (event) {
                ...
                $__default["default"](stepEl).trigger('change');
            },
            ...
            moveStepUp: function (stepIndex) {
                var _this = this;
                if (stepIndex > 0) {
                    var $thisItem_1 = $__default["default"]("#cc-product-finder-step-".concat(stepIndex));
                    var $prevItem_1 = $__default["default"]("#cc-product-finder-step-".concat(stepIndex - 1));
                    $thisItem_1.addClass('cc-product-finder-configurator__step--animating').css('transform', "translateY(".concat(-Math.abs($prevItem_1.outerHeight(true)), "px)"));
                    $prevItem_1.addClass('cc-product-finder-configurator__step--animating').css('transform', "translateY(".concat($thisItem_1.outerHeight(true), "px)"));
                    setTimeout(function () {
            ...
            moveStepDown: function (stepIndex) {
                ...
                if (stepIndex < this.configuration.steps.length - 1) {
                    var $thisItem_2 = $__default["default"]("#cc-product-finder-step-".concat(stepIndex));
                    var $nextItem_1 = $__default["default"]("#cc-product-finder-step-".concat(stepIndex + 1));
                    $thisItem_2.addClass('cc-product-finder-configurator__step--animating').css('transform', "translateY(".concat($nextItem_1.outerHeight(true), "px)"));
                    $nextItem_1.addClass('cc-product-finder-configurator__step--animating').css('transform', "translateY(".concat(-Math.abs($thisItem_2.outerHeight(true)), "px)"));
                    setTimeout(function () {
                        _this.configuration.steps.splice(stepIndex + 1, 0, _this.configuration.steps.splice(stepIndex, 1)[0]);
    ...
    var productsGridConfigurator = {
        ...
        data: function () {
            return {
                ...
                scenarioOptions: {
                    rows_mobile: {
                        1: {
                            name: $t__default["default"]('1 row of products'),
                            iconId: 'pr_1',
                        },
                        2: {
                            name: $t__default["default"]('2 rows of products'),
                            iconId: 'pr_2',
                        },
                        3: {
                            name: $t__default["default"]('3 rows of products'),
                            iconId: 'pr_3',
                        },
                        4: {
                            name: $t__default["default"]('4 rows of products'),
                            iconId: 'pr_4',
                        },
                        1000: {
                            name: $t__default["default"](' rows of products'),
                            iconId: 'pr_custom',
                        },
                    },
                    rows_tablet: {
                    ...
                    useTeaser: {
                        '': {
                            name: $t__default["default"]('No image teaser'),
                            iconId: 'no_teaser',
                        },
                        true: {
                            name: $t__default["default"]('With image teaser'),
                            iconId: 'teaser_left',
                        },
                    },
                },
        ...
        ready: function () {
            ...
            // Get categories JSON with AJAX
            this.$http.get(this.categoriesDataUrl).then(function (response) {
                _this.categoryPicker = new categoryPicker($__default["default"]('#cfg-pg-category'), JSON.parse(response.body), {
                    multiple: false,
                });
                // Hide loader
                $__default["default"]('body').trigger('hideLoadingPopup');
                $__default["default"]('.tmp-select').remove();
            });
        },
    };
        ...
        methods: {
            ...
            deleteTeaserItem: function (index) {
                ...
                confirm__default["default"]({
                    ...
                    actions: {
                        confirm: function () {
                            component.$set("configuration.items[".concat(index, "]"), JSON.parse(JSON.stringify(teaserPrototype)));
                        },
                    },
                });
            }
    ...
    var accordionConfigurator = {
                                ...
                                items: [
                                    {
                                        ...
                                        content: '',
                                        isEditorOpened: true,
                                        editorId: "editor_".concat((Math.random() * (99999999 - 10000 + 1)) << 0),
                                    },
                                ],
                            })),
                        ],
        ...
        events: {
            ...
            'component-configurator__save': function () {
                ...
                Object.keys(this.configuration.groups).forEach(function (groupIndex) {
                    Object.keys(_this_1.configuration.groups[groupIndex].items).forEach(function (itemIndex) {
                        _this_1.$set("configuration.groups[".concat(groupIndex, "].items[").concat(itemIndex, "].content"), _this_1.fixMarkup(_this_1.configuration.groups[groupIndex].items[itemIndex].content));
                        delete _this_1.configuration.groups[groupIndex].items[itemIndex].editorInitialized;
                    });
                });
                this.onSave();
            },
        ...
        methods: {
            ...
            deleteGroup: function (index) {
                var component = this;
                confirm__default["default"]({
                    content: $__default["default"].mage.__('Are you sure you want to delete this group?'),
                    actions: {
                        confirm: function () {
                            Object.keys(component.configuration.groups[index].items).forEach(function (itemIndex) {
                                delete component.editorInstances["editor_".concat(index, "_").concat(itemIndex)];
                            });
            ...
            moveGroupUp: function (index) {
                var _this_1 = this;
                if (index > 0) {
                    var $thisItem_1 = $__default["default"]("#cc-accordion-group-".concat(index));
                    var $prevItem_1 = $__default["default"]("#cc-accordion-group-".concat(index - 1));
                    $thisItem_1
                    ...
                    $prevItem_1
                        ...
                        .css('transform', "translateY(".concat($thisItem_1.outerHeight(true), "px )"));
                    setTimeout(function () {
                        var thisGroupItems = _this_1.configuration.groups[index].items;
                        var prevGroupItems = _this_1.configuration.groups[index - 1].items;
                        Object.keys(thisGroupItems).forEach(function (itemIndex) {
                            if (thisGroupItems[itemIndex].isEditorOpened) {
                                _this_1.editorInstances[thisGroupItems[itemIndex].editorId].toggle();
                            }
                        });
                        Object.keys(prevGroupItems).forEach(function (itemIndex) {
                            if (prevGroupItems[itemIndex].isEditorOpened) {
                                _this_1.editorInstances[prevGroupItems[itemIndex].editorId].toggle();
                            }
                        });
                        _this_1.configuration.groups.splice(index - 1, 0, _this_1.configuration.groups.splice(index, 1)[0]);
                        $thisItem_1
            ...
            moveGroupDown: function (index) {
                ...
                if (index < this.configuration.groups.length - 1) {
                    var $thisItem_2 = $__default["default"]("#cc-accordion-group-".concat(index));
                    var $nextItem_1 = $__default["default"]("#cc-accordion-group-".concat(index + 1));
                    $thisItem_2
                        .addClass('cc-accordion-configurator__group--animating')
                        .css('transform', "translateY(".concat($nextItem_1.outerHeight(true), "px)"));
                    $nextItem_1
                    ...
                    setTimeout(function () {
                        var thisGroupItems = _this_1.configuration.groups[index].items;
                        var nextGroupItems = _this_1.configuration.groups[index + 1].items;
                        ...
                        Object.keys(nextGroupItems).forEach(function (itemIndex) {
                            if (nextGroupItems[itemIndex].isEditorOpened) {
                                _this_1.editorInstances[nextGroupItems[itemIndex].editorId].toggle();
                            }
                        });
                        _this_1.configuration.groups.splice(index + 1, 0, _this_1.configuration.groups.splice(index, 1)[0]);
                        $thisItem_2
                ...
                confirm__default["default"]({
                    ...
                    actions: {
                        confirm: function () {
                            ...
                            delete component.editorInstances["editor_".concat(groupIndex, "_").concat(index)];
                        },
                    },
                });
            },
            ...
            moveItemUp: function (groupIndex, index) {
                var _this_1 = this;
                if (index > 0) {
                    var $thisItem_3 = $__default["default"]("#cc-accordion-item-".concat(groupIndex, "-").concat(index));
                    var $prevItem_2 = $__default["default"]("#cc-accordion-item-".concat(groupIndex, "-").concat(index - 1));
                    $thisItem_3
                        .addClass('cc-accordion-configurator__item--animating')
                        .css('transform', "translateY(".concat(-Math.abs($prevItem_2.outerHeight(true)), "px)"));
                    $prevItem_2
                        .addClass('cc-accordion-configurator__item--animating')
                        .css('transform', "translateY(".concat($thisItem_3.outerHeight(true), "px )"));
                    setTimeout(function () {
                        var thisItem = _this_1.configuration.groups[groupIndex].items[index];
                        var prevItem = _this_1.configuration.groups[groupIndex].items[index - 1];
                        // Due to TinyMCE bug we need to disable editor before if changes its DOM position (if turned on)
                        if (thisItem.isEditorOpened) {
                            _this_1.editorInstances[thisItem.editorId].toggle();
                        }
                        if (prevItem.isEditorOpened) {
                            _this_1.editorInstances[prevItem.editorId].toggle();
                        }
                        _this_1.configuration.groups[groupIndex].items.splice(index - 1, 0, _this_1.configuration.groups[groupIndex].items.splice(index, 1)[0]);
                        $thisItem_3
            ...
            moveItemDown: function (groupIndex, index) {
                ...
                if (index < this.configuration.groups[groupIndex].items.length - 1) {
                    var $thisItem_4 = $__default["default"]("#cc-accordion-item-".concat(groupIndex, "-").concat(index));
                    var $nextItem_2 = $__default["default"]("#cc-accordion-item-".concat(groupIndex, "-").concat(index + 1));
                    $thisItem_4
                        .addClass('cc-accordion-configurator__item--animating')
                        .css('transform', "translateY(".concat($nextItem_2.outerHeight(true), "px)"));
                    $nextItem_2
                        .addClass('cc-accordion-configurator__item--animating')
                        .css('transform', "translateY(".concat(-Math.abs($thisItem_4.outerHeight(true)), "px)"));
                    setTimeout(function () {
                        var thisItem = _this_1.configuration.groups[groupIndex].items[index];
                        var nextItem = _this_1.configuration.groups[groupIndex].items[index + 1];
                        if (thisItem.isEditorOpened) {
                            _this_1.editorInstances[thisItem.editorId].toggle();
                        }
                        if (nextItem.isEditorOpened) {
                            _this_1.editorInstances[nextItem.editorId].toggle();
                        }
                        _this_1.configuration.groups[groupIndex].items.splice(index + 1, 0, _this_1.configuration.groups[groupIndex].items.splice(index, 1)[0]);
                        $thisItem_4
                            .removeClass('cc-accordion-configurator__item--animating')
            ...
            initAllWysiwygEditors: function () {
                ...
                Object.keys(this.configuration.groups).forEach(function (groupIndex) {
                    Object.keys(_this_1.configuration.groups[groupIndex].items).forEach(function (itemIndex) {
                        _this_1.initWysiwyg(Number(groupIndex), Number(itemIndex));
                    });
                });
            },
            /* Opens modal with M2 built-in widget chooser
            ...
            openWidgetModal: function (editorId) {
                widgetTools.openDialog("".concat(this.wysiwygCfg.plugins[1].options.window_url, "widget_target_id/").concat(editorId, "/"));
            },
            /* Opens modal with M2 built-in media uploader
             */
            openMediaModal: function (editorId) {
                MediabrowserUtility.openDialog("".concat(this.uploaderBaseUrl, "target_element_id/").concat(editorId, "/"), 'auto', 'auto', $__default["default"].mage.__('Insert File...'), {
                    closed: true,
                });
            },
            /* Opens modal with M2 built-in variables
            ...
            initWysiwyg: function (groupIndex, index) {
                ...
                require([
                    ...
                    _this.$set("editorInstances.".concat(item.editorId), new wysiwygSetup(item.editorId, _this.wysiwygCfg));
                    if (item.isEditorOpened) {
                        _this.editorInstances[item.editorId].setup('exact');
                        _this.$set("configuration.groups[".concat(groupIndex, "].items[").concat(index, "].editorInitialized"), true);
                    }
                });
            },
            /**
            ...
            toggleEditor: function (editorId, groupIndex, index) {
                if (this.configuration.groups[groupIndex].items[index].hasOwnProperty('editorInitialized')) {
                    ...
                    this.$set("configuration.groups[".concat(groupIndex, "].items[").concat(index, "].editorInitialized"), true);
                }
                this.$set("configuration.groups[".concat(groupIndex, "].items[").concat(index, "].isEditorOpened"), !this.configuration.groups[groupIndex].items[index].isEditorOpened);
            },
            /**
             * 1. Replaces all self-closing tags to simple closing mark
             * 2. Replaces special chars for quots (&quot;) to the single quote mark
    ...
    var productTeaserConfigurator = {
        ...
        events: {
            ...
            'component-configurator__save': function () {
                ...
                if (this.configuration.sku !== '') {
                    ...
                    this.$set('errorMessage', $t__default["default"]('SKU is required.'));
                    this.onSave();
                }
            },
        },
        ...
        methods: {
            ...
            getProductData: function () {
                ...
                $__default["default"]('body').trigger('showLoadingPopup');
                this.$http
                    .get("".concat(this.productDataEndpoint, "?sku=").concat(this.configuration.sku))
                    .then(function (response) { return _this_1.handleUpdate(response); }, function () {
                    _this_1.validate();
                    $__default["default"]('body').trigger('hideLoadingPopup');
                });
            },
            ...
            validate: function () {
                if (!this.configuration.product || this.configuration.product.name === '') {
                    this.$set('configuration.isError', true);
                    this.$set('errorMessage', $t__default["default"]('Can\'t find product with given SKU. Please verify SKU and try again.'));
                }
                this.onSave();
            },
            updateBackgroundValue: function (e) {
                this.$set("configuration.background", e.target.value);
            },
            /**
             * Initializes TinyMCE WYSIWYG with given configuration (this.wysiwygConfig).
             */
            initSpecialDescriptionWysiwyg: function () {
                var _this = this;
                require([
                    'mage/adminhtml/wysiwyg/tiny_mce/setup',
                ], function () {
                    var sloganEditor = new wysiwygSetup("cfg-pc-special-description", _this.wysiwygConfig);
                    sloganEditor.setup('exact');
                });
            },
        },
    ...
    // Use Vue resource
    Vue__default["default"].use(vr__default["default"]);
    // Set Vue's $http headers Accept to text/html
    Vue__default["default"].http.headers.custom.Accept = 'text/html';
    ...
    var pickerModalOptions = {
        ...
        innerScroll: true,
        autoOpen: true,
        title: $t__default["default"]('Please select type of component'),
        buttons: [
            {
                text: $__default["default"].mage.__('Cancel'),
                class: '',
                click: function () {
                    this.closeModal();
                },
    ...
    var configuratorModalOptions = {
        ...
        innerScroll: true,
        autoOpen: true,
        title: $t__default["default"]('Configure your component'),
        buttons: [
            {
                text: $__default["default"].mage.__('Cancel'),
                class: '',
            ...
            {
                text: $__default["default"].mage.__('Save'),
     ...
     */
    $__default["default"]('.admin__control-wysiwig').attr('v-pre', true);
    /**
    ...
    var contentConstructor = {
        ...
        ready: function () {
            var targetComponentMatch = $__default["default"](this.$el)
            ...
            'component-configurator__saved': function (data) {
                if (!data.hasOwnProperty('isError') ||
                    ...
                    if (data.hasOwnProperty('showErrorAlert') && data.showErrorAlert) {
                        alert__default["default"]({
                            title: $t__default["default"]('Hey,'),
                            content: $__default["default"].mage.__('Something is wrong with configuration of your component. Please fix all errors before saving.'),
                        });
                    }
                }
            },
        ...
        methods: {
            getCCconfig: function () {
                var ccConfig = this.ccProjectConfig
                    ...
                    : {};
                return !$__default["default"].isEmptyObject(ccConfig)
            ...
            getComponentPicker: function (addComponentInformation) {
                var component = this;
                var modalId = "content-constructor-picker-".concat(this.pageType);
                ...
                pickerModalOptions.opened = function () {
                    if (!component._isPickerLoaded) {
                        ...
                        // Get picker via AJAX
                        component.$http
                            .get("".concat(component.configuratorEndpoint, "picker"))
                            .then(function (response) {
                ...
                if ($pickerModal && $pickerModal.modal.attr('id') === modalId) {
                    ...
                    $pickerModal = modal__default["default"](pickerModalOptions, $__default["default"](this.$els.pickerModal));
            ...
            initConfiguratorModal: function (componentInformation) {
                ...
                configuratorModalOptions.title = "".concat($t__default["default"]('Configure your component'), "<span class=\"m2c-content-constructor__modal-subheadline\">").concat(this.transformComponentTypeToText(componentInformation.type), "</span>");
                ...
                $configuratorModal = modal__default["default"](configuratorModalOptions, $__default["default"](this.$els.configuratorModal));
            },
            /**
             ...
             */
            disableDesignInheritance: function () {
                uiRegistry__default["default"]
                    .get(this.pageType)
            ...
            setRestToken: function () {
                ...
                this.$http
                    ...
                    .then(function (response) {
                    component.restToken = "Bearer ".concat(response.body);
                });
            },
            deleteStaticBlock: function (cmsBlockId) {
                var component = this;
                ...
                this.$http({
                    ...
                    method: 'delete',
                    url: "".concat(window.location.origin, "/rest/V1/cmsBlock/").concat(cmsBlockId),
                }).then(function (response) {
                    if (response.body !== 'true') {
                        console.warn("Something went wrong, CMS block wasn't removed, please check if block with ID: ".concat(cmsBlockId, " exists in database"));
                    }
                });
            },
            transformComponentTypeToText: function (componentType) {
