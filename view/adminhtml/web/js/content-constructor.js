        ...
        methods: {
            ...
            duplicateComponent: function (index) {
                ...
                this.$nextTick(function () {
                    var $origin = $__default["default"]("#".concat(_this.components[index].id));
                    var $duplicate = $__default["default"]("#".concat(duplicate.id));
        ...
        methods: {
                ...
                img.onload = function () {
                    ...
                    if (_this.currentImageUploader !== 'desktop') {
                        if (_this.configuration.image[_this.currentImageUploader] && _this.configuration.image[_this.currentImageUploader].image) {
                            _this.$set("configuration.image.".concat(_this.currentImageUploader, ".image"), imgPath);
                        }
                        else {
                            _this.$set("configuration.image.".concat(_this.currentImageUploader, ".raw"), imgPath);
                        }
                        _this.$set("configuration.image.".concat(_this.currentImageUploader, ".aspect_ratio"), aspectRatio);
                    }
                    else {
                        ...
                        ['mobile', 'tablet', 'desktop'].forEach(function (item) {
                            if (item === 'desktop') {
                                ...
                                if (_this.configuration.image[item].aspect_ratio === '') {
                                    _this.$set("configuration.image.".concat(item, ".image"), imgPath);
                                    _this.$set("configuration.image.".concat(item, ".raw"), imgPath);
                                    _this.$set("configuration.image.".concat(item, ".aspect_ratio"), aspectRatio);
                                    _this.$set("configuration.image.".concat(item, ".decoded"), decoded);
                                }
                            }
                        });
                    }
            ...
            handleJqEvents: function () {
                ...
                $__default["default"](".cc-teaser-configurator__video-url[data-teaser-index=\"".concat(this.teaserIndex, "\"]"))
                    .off('change')
                    .on('change', function (event) { _this.onVideoFileUrlChange(event, _this.teaserIndex); });
            },
